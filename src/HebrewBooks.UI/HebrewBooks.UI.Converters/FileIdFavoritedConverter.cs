...
public sealed class FileIdFavoritedConverter : IMultiValueConverter
{
	public object Convert(object[] values, Type targetType, object? parameter, CultureInfo culture)
	{
		...
		return values[1] is LibraryViewModel libraryViewModel && libraryViewModel.IsFavorited(fileId);
	}
